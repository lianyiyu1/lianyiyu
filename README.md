...
![Canvas](https://img.shields.io/badge/Canvas-FF6F00?style=for-the-badge&logo=html5&logoColor=white)
...
#### 🏯 Sichuan Intangible Cultural Heritage Digital Business Card  
*AI + Sustainable Development Competition Project*  
- Built a digital platform to showcase and preserve Sichuan's intangible cultural heritage  
- Integrated an AI chatbot for interactive cultural experiences  
- Visualized heritage distribution and inheritance status using ECharts  
- **Tech:** Python, JavaScript, ECharts, AI Agent  

#### 📊 Student Data Visualization System  
*Course Project*  
- Developed a comprehensive student performance and behavior analysis system  
- Created interactive charts and dashboards with Canvas and ECharts  
- Implemented data filtering, sorting, and export functionalities  
- **Tech:** Java, JavaScript, Canvas, ECharts  

#### 🗜️ Huffman Coding Implementation  
*Data Structures Course Project*  
- Implemented Huffman coding for file compression and decompression  
- Designed a user-friendly command-line interface  
- Optimized algorithm for improved performance  
- **Tech:** Java  
...
✅ Completed Java Engineer certification  
✅ Mastered data structures and algorithms fundamentals  
✅ Built first full-stack web application  
✅ Deployed local large language model  
...
- 📖 Reading Chinese classical literature (especially *Dream of the Red Chamber*) and modern novels  
- 🎬 Watching thought-provoking films  
- 🍳 Exploring healthy cooking and tracking nutrition  
- 🌿 Learning about traditional Chinese culture and intangible heritage  
- ✍️ Writing technical blogs and sharing my learning experiences  
...
📧 **Email:** [13408315751@163.com](mailto:yulianyi@example.com)  
💼 **GitHub:** [@yulianyi](https://github.com/yulianyi)  


---

<p align="center">⭐️ From <a href="https://github.com/yulianyi">yulianyi</a> | Last updated: May 2026</p>
